...
nohup java -jar \
  -Dspring.config.location=classpath:/application.properties,classpath:/home/ec2-user/app/properties/application.properties,/home/ec2-user/app/properties/application-oauth.properties \
